...
const Dashboard = () => {
  return (
    <div className="bg-rose-silk min-h-screen px-6 py-10 font-clean animate-fade-in">
      <h1 className="text-4xl font-elegant text-plum mb-8 animate-slide-up">Your Sanctuary</h1>
      ...
      <div className="bg-white rounded-2xl shadow-md p-6 mb-8">
        ...
        <p className="italic text-sm text-rose-mauve">“Your skin speaks poetry – every glow a stanza.”</p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-md p-6 mb-8">
        ...
        <Link to="/journal" className="text-plum underline text-sm mt-2 inline-block">See all entries</Link>
      </div>
      ...
      <div className="bg-rose-petal border-l-4 border-gold p-4 rounded-lg shadow-inner mb-8">
        ...
        <p className="text-rose-mauve text-sm">Lightweight gels keep pores happy and hydrated without feeling heavy.</p>
      </div>

      {/* Quick Action Buttons */}
      <div className="flex flex-wrap gap-4">
        <Link to="/routine" className="bg-plum text-white px-5 py-2 rounded-full hover:bg-opacity-80 transition-all">Log Routine</Link>
        <Link to="/journal" className="border border-plum text-plum px-5 py-2 rounded-full hover:bg-rose-blush">Write Journal</Link>
        <Link to="/product-checker" className="bg-gold text-white px-5 py-2 rounded-full hover:opacity-90">Check Ingredient</Link>
      </div>
    </div>
  );
};
